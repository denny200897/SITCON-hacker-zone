...
var translations = map[language]copyText{
	languageEnglish: {
		...
		bannerHint:      "Type /help for commands · Enter to send · Ctrl+C to exit",
		placeholder:     "Type a command or /help …",
		starting:        "Starting…",
		hiddenInput:     "(input hidden)",
		secretHint:      "  🔒 Secret input · Enter to save · never displayed or stored as plaintext",
		normalHint:      "  /help commands · /lang zh 中文 · /copy or Ctrl+Y copy · ↑↓/PgUp scroll",
	...
	languageChinese: {
		...
		bannerHint:      "輸入 /help 顯示指令 · Enter 送出 · Ctrl+C 離開",
		placeholder:     "輸入指令或 /help …",
		starting:        "啟動中…",
		hiddenInput:     "（已隱藏輸入）",
		secretHint:      "  🔒 密鑰輸入模式 · Enter 儲存 · 內容永不顯示或以明文落盤",
		normalHint:      "  /help 指令 · /lang en English · /copy 或 Ctrl+Y 複製 · ↑↓/PgUp 捲動",
